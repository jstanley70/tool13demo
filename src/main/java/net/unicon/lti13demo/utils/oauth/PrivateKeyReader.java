...
public class PrivateKeyReader {
	...
	public PrivateKey getPrivateKey(File f) throws IOException, GeneralSecurityException {
		...
		try {
			...
			return getKey(builder.toString(), isRSAKey);
	...
	private PrivateKey getKey(String keyString, Boolean isRSAKey) throws NoSuchAlgorithmException, IOException, InvalidKeySpecException {
